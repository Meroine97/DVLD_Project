...
namespace DVLD_Business
{
    public class clsApplication
    {
        ...
        public bool Delete()
        {
            return clsApplicationData.DeleteApplication(this.ApplicantPersonID);
        }
        ...
        public bool DoesPersonHaveActiveApplicationID(int ApplicationTypeID)
        {
            return clsApplicationData.DoesPersonHaveActiveApplication(this.ApplicantPersonID, ApplicationTypeID);
        }

        public static int GetActiveApplicationID(int PersonID, 
                clsApplication.enApplicationType ApplicationTypeID)
        {
            return clsApplicationData.GetActiveApplicationID(PersonID, (int)ApplicationTypeID);
        }
        public int GetActiveApplicationTypeID(clsApplication.enApplicationType ApplicationTypeID)
        {
        ...
        public int GetActiveApplicationIDForLicenseClass(clsApplication.enApplicationType ApplicationTypeID,
            int LicenseClassID)
        {
            return clsApplicationData.GetActiveApplicationIDForLicenseClass(this.ApplicantPersonID,
