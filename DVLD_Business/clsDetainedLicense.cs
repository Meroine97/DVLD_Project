...
namespace DVLD_Business
{
    public class clsDetainedLicense
    {
        ...
        public static clsDetainedLicense Find(int DetainID)
        {
            ...
            bool isFound = clsDetainedLicenseData.GetDetainedLicenseByID(DetainID, ref LicenseID,
        ...
        public static clsDetainedLicense FindByLicenseID(int LicenseID)
        {
            ...
            bool isFound = clsDetainedLicenseData.GetDetainedLicenseInfoByLicenseID(LicenseID, ref DetainID,
                ref DetainDate, ref FineFees, ref CreatedByUserID, ref IsReleased, ref ReleaseDate,
                ref ReleasedByUserID, ref ReleaseApplicationID);
        ...
        {
            return clsDetainedLicenseData.GetAllDetianedLicenses();
        }
    }
}
